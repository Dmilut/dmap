...
public class DataConvertor {
	 ...
	 * 
	 * @param type
	 *            field type (model calls it domain)
	 * @param value
	 *            value as read from JSON
	 ...
	 * 
	 * @param fieldName
	 *            field name as read from JSON
	 * @param type
	 *            field type (model calls it domain)
	 * @param sub
	 *            data as from JSON
	 * @param out
	 *            consumer to eat parsed name/value pairs.
	 */
	...
	public static void parseAnything(String fieldName, Object data, BiConsumer<String, String> out) {
		if ((data instanceof String) || (data instanceof Integer) || (data instanceof Long) || (data instanceof Double)
	 ...
	 * 
	 * @param domain
	 * @return True if fields of this domain can't be used as data filters
	 *         (directly).
	 */
